/* =====================================================================================
   ...
   - The "maximum speed" target (TARGET_SCAN_HZ) is a placeholder -- LD-series DTOF
     LiDARs in this family are commonly specced in the 5-13 Hz range, but the
     datasheet explicitly says actual speed varies motor-to-motor, which is why this
     sketch closes the loop on the LiDAR's own reported speed field rather than just
     writing a fixed PWM duty cycle and hoping. Check your unit's exact spec/label.
...
#define TARGET_SCAN_HZ     13.0f       // "max speed" target -- verify vs your unit's spec
